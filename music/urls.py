...
urlpatterns = [
    ...
    url(r'^(?P<album_id>[0-9]+)/delete_song/(?P<current_template>[a-zA_Z]+)/(?P<song_id>[0-9]+)/$', views.delete_song,
        name='delete_song'),
    url(r'^(?P<album_id>[0-9]+)/update/$', views.album_update_view, name='album-update'),
    url(r'^(?P<album_id>[0-9]+)/(?P<current_template>[a-zA_Z]+)/favorite_album/$', views.favorite_album,
        name='favorite_album'),
    url(r'^(?P<song_id>[0-9]+)/(?P<current_template>[a-zA_Z]+)/favorite/$', views.favorite, name='favorite'),
